	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('assets/images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="login_owner.php" method="POST">
				<a href="index.html">	<img src="assets/img/logo-dark.png" style="display: block; margin-left: auto; margin-right: auto; padding-bottom: 20px;" > </a>
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is required">
						...
						<input id="username" class="input100" type="text" name="email" placeholder="Type your Email">
