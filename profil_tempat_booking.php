    ...
    <div class="features-container section-container">
        <div class="container">
            <div class="col-sm-7">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $record['jenis_lapangan']; ?>
                                </td>
                            </tr>
                            <tr>
                                <td><b>Deskripsi</b></td>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered table-inverse table-responsive">
							...
							$list_booking = json_decode($record['terbooking'],true);
						?>
                                <tr>
                            ...
                            <tbody>
                                <?php
									foreach($list_booking as $index){	
								?>
                                <tr>
                                    <td scope="row">
                                        <?php echo $index["tanggal"]; ?>
                                    </td>
                                    <td>
                                        <?php echo $index["jam"]; ?>
                                    </td>
                                    <td>
                                        <?php echo $index["durasi"], " Jam"; ?>
                                    </td>
                                </tr>
                                <?php
									 } 
                ...
                <br>
                <a href="form_booking.php?id=<?php echo $_GET['id']?>" class="btn btn-success">Booking</a>
            ...
            <div class="col-sm-2 features section-description wow fadeIn">
                ...
                <i style=" margin-top: 2%; margin-left: 8%;" class="fa" data-toggle="tooltip" data-placement="bottom"
                    title="SHOWER">&#xf2cc;</i>
                <i style=" margin-top: 2%; margin-left: 8%;" class="fa" data-toggle="tooltip" data-placement="bottom"
                    title="PARKIR">&#xf1b9;</i>
                <br><br>
                <h4 style="margin-top: 2%; margin-left: 8%;">Kontak</h4>
                <i style=" margin-top: 2%; margin-left: 8%;" class="fa">&#xf095;
                    <?php echo $row['phone'];?></i>
                <i style=" margin-top: 2%; margin-left: 8%;" class="glyphicon">&#x2709;
                    <?php echo $row['email'];?></i>
